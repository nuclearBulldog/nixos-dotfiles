...
if [[ $ANTIGEN_CACHE != false ]]; then
  ANTIGEN_CACHE="${ANTIGEN_CACHE:-${ADOTDIR:-$HOME/.config/zsh/.antigen}/init.zsh}"
  ANTIGEN_RSRC="${ANTIGEN_RSRC:-${ADOTDIR:-$HOME/.config/zsh/.antigen}/.resources}"
...
-antigen-env-setup () {
  ...
  -antigen-set-default ANTIGEN_COMPDUMP "${ADOTDIR:-$HOME/.config/zsh}/.zcompdump"
