...
/* appearance */
static unsigned int borderpx        = 0.5;        /* border pixel of windows */
...
static const char *fonts[]          = { "monospace:size=22", "Hack Nerd Font Mono:size=18", "NotoColorEmoji:pixelsize=16:antialias=true:autohint=true"  };
...
static const Rule rules[] = {
	...
	{ "St",      NULL,     "St",               0,    0,          1,           0,        -1 },
	{ "firefox", NULL,     "Firefox",          0,    0,          0,           0,        -1 },
	{ "nvim",    NULL,     "nvim",             0,    0,          0,           0,        -1 },
